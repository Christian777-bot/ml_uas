...
def load_model():
    ...
    return xgb_model, le, info.get("xgb_accuracy", 0.0)


xgb_model, le, xgb_acc = load_model()

if xgb_model is None:
    st.stop()

# --- 2. UI Header ---
st.set_page_config(page_title="Prediksi Obesitas (XGBoost)", layout="wide")
st.title("BMI Classification Predictor (XGBoost Only)")
st.caption(f"XGBoost Accuracy: **{xgb_acc:.4f}**")
st.markdown("---")
